...
#define TOPIC      "CamGrav/feeds/weather.indicator"
...
int main(int argc, char* argv[]) {
  ...
  gpio60.setDirection(OUTPUT);
  GPIO_VALUE gpio46Value = gpio46.getValue();
  gpio60.setValue(gpio46Value);


   sprintf(str_payload, "%d", gpio46Value == HIGH ? 1 : 0);
